...
import csv
with open('/Users/GengyuanMax/Downloads/translation_rtranse_tail_emb.tsv', 'w') as f:
    tsv_w = csv.writer(f, delimiter='\t')
    tsv_w.writerows(head_ent_emb.tolist())
...
#     X_tsne = TSNE(n_components=2,perplexity=n,random_state=13,n_iter=4000).fit_transform(head_ent_emb0)
#
#
#     #
